    ...
    <div className="flex min-h-screen justify-center bg-[#121212] font-sans text-white">
      <div className="relative flex w-full max-w-[750px] flex-col">
        ...
        <header className="flex items-center justify-between p-4">
          ...
          <h1 className="text-body1">배민녀</h1>
        ...
        {isModalOpen && (
          ...
          >
            <div
              className="border-text-disabled text-body2 rounded-[5px] border bg-[#262626]"
              onClick={(e) => e.stopPropagation()}
            >
              <button
                className="text-text-default block w-full px-6 py-2 text-left"
                onClick={() => setIsModalOpen(false)}
              >
                팔로잉
              </button>
