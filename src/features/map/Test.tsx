...
const selections = {
  time: ['00:00', '00:30', '01:00', '01:30', '02:00', '02:30', '03:00', '03:30'],
};

type ColumnName = keyof typeof selections; // "time"
    ...
    <div className="bg-bg-main flex w-[375px] flex-col justify-center">
      ...
      <div className="bg-bg-board rounded-tl-[20px] rounded-tr-[20px] px-[15px] pt-[30px] pb-[18px]">
        <div className="mb-[35px] flex">
          <div className="w-[50%]">
            <h3 className="text-text-default text-center text-[16px]">시작 시간</h3>
            <Picker
              value={pickerValue}
          ...
          <div className="w-[50%]">
            <h3 className="text-text-default text-center text-[16px]">종료 시간</h3>
          </div>
        </div>
