...
export const mapEventsQueryKey = (params: EventsParams) => ['events', params] as const;

export function useMapEventsQuery(params: EventsParams) {
  return useQuery({
    queryKey: mapEventsQueryKey(params),
